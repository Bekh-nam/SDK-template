...
git clone git@github.com: $DOCS_DIR
...
echo 'Generated from `src` in [aptos-core](https://github.com/Bekh-nam/SDK-template) using `pnpm generate-ts-docs`.' >> $DOCS_DIR/README.md
